...
from .models import (Evento,CadastroEscola,CapacidadesFundamentos,UnidadeCurricular, UnidadeCapacidade,Periodo,
                     HoraAulaCargaHoraria, Pessoa, Areatecnologica, Infraestrutura, Turma, AulaInfraestrutura, Aula)
from .serializers import (EventoSerializer,CadastroEscolaSerializer,CapacidadesFundamentosSerializer, 
                          UnidadeCurricularSerializer, UnidadeCapacidadeSerializer, PeriodoSerializer,
                          HoraAulaCargaHorariaSerializer, PessoaSerializer, AreaTecnologicaSerializer, 
                          InfraestruturaSerializer, TurmaSerializer, AulaInfraestruturaSerializer, 
                          AulaSerializer)
