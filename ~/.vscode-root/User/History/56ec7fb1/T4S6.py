...
from .models import (Evento,CadastroEscola,CapacidadesFundamentos,UnidadeCurricular, UnidadeCapacidade,AulaInfraestrutura, Infraestrutura, Aula,
                     Pessoa,Areatecnologica, Turma,  Periodo, HoraAulaCargaHoraria)
from .serializers import (EventoSerializer,CadastroEscolaSerializer,CapacidadesFundamentosSerializer, UnidadeCurricularSerializer, UnidadeCapacidadeSerializer,  InfraestruturaSerializer, AulaInfraestruturaSerializer, 
