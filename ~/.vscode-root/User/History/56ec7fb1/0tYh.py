...
from .models import (Evento,CadastroEscola,CapacidadesFundamentos,UnidadeCurricular, UnidadeCapacidade,Periodo,
                     AulaInfraestrutura, Infraestrutura, Aula,
                     Pessoa,Areatecnologica, Turma,   HoraAulaCargaHoraria)
from .serializers import (EventoSerializer,CadastroEscolaSerializer,CapacidadesFundamentosSerializer, UnidadeCurricularSerializer, UnidadeCapacidadeSerializer,
                          PeriodoSerializer, InfraestruturaSerializer, AulaInfraestruturaSerializer, 
                          AulaSerializer,  UnidadeCurricularSerializer2,
                           PessoaSerializer, HoraAulaCargaHorariaSerializer,
