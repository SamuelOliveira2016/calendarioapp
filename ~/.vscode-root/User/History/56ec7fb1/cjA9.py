...
from .models import (Evento,CadastroEscola,CapacidadesFundamentos,UnidadeCurricular, UnidadeCapacidade,Periodo,
                     PeriodoDetalhe, HoraIntervalo, Pessoa, Areatecnologica, Infraestrutura, Turma, Aula, AulaInfraestrutura,
                     AulaProfessor)
from .serializers import (EventoSerializer,CadastroEscolaSerializer,CapacidadesFundamentosSerializer, 
                          ...
                          PeriodoDetalheSerializer, HoraIntervaloSerialilzer, PessoaSerializer, AreaTecnologicaSerializer, 
