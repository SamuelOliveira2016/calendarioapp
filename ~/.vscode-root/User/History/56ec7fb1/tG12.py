...
from .serializers import (InfraestruturaSerializer, AulaInfraestruturaSerializer, CalendarioAulaSerializer,
                          ...
                          ProfessorSerializer,UnidadeCurricularSerializer,VinculoSerializer, PessoaSerializer,
                          TipoCursoSerializer, AreaTecnologicaSerializer, CursoSerializer, HoratrabProfSerializer)
