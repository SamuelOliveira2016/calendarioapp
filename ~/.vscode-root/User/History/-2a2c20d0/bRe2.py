...
from .models import AulaInfraestrutura, Pessoa,  HoratrabProf, Areatecnologica,  UnidadeCurricular, Infraestrutura, Curso, CursoUnidadeCurricularProfessor, CalendarioAcademico, DiaLetivo, Evento, Aula, CalendarioAula
