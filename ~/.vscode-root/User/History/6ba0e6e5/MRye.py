...
class Infraestrutura(models.Model):
    ...
    cor = models.CharField(max_length=50, default='cinza')
...
class Aula(models.Model):
    professor = models.ForeignKey(Pessoa, on_delete=models.CASCADE, default=1)
    UnidadeCurricularF=models.ForeignKey(UnidadeCurricular, on_delete=models.CASCADE, default=1)
    turma=models.ForeignKey(Turma,on_delete=models.CASCADE, default=1)
    infraestrutura=models.ForeignKey(Infraestrutura,on_delete=models.CASCADE, default=1)
    def __str__(self):
        uc_nome = self.turma
