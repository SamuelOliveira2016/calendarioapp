...
class Capacidade(models.Model):
    ...
    def __str__(self):
        return self.descricao_capacidade
...
class HoraIntervalo(models.Model):
    ...
    def __str__(self):
        return f'Intervalos - Hora Início {self.hora_ini} e hora Fim {self.hora_fim}.'
...
class AreaTecnologica(models.Model):
    ...
    def __str__(self):
        return self.descricao_area_tecnologica
