...
class Capacidades(models.Model):
    '''Tabela para receber as capaidades técnicas de cada curso, os dados necessários são,
    setar se é uma capacidade social ou técnica'''
    ...
    TIPO_CAPACIDADE = [(1,"Capacidade Socioemocional"),
                       (2,"Capacidade Fundamento Técnico")]
    
    tipo = models.IntegerField(choices=TIPO_CAPACIDADE, default=2)
