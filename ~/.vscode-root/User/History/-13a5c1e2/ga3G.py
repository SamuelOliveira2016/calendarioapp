...
from .models import (Evento, CadastroEscola,CapacidadesFundamentos, UnidadeCurricular, UnidadeCapacidade, Infraestrutura,AulaInfraestrutura, 
                     Aula,  Pessoa, Turma,  Areatecnologica, Periodo, HoraAulaCargaHoraria)
