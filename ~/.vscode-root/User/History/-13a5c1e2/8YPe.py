...
from .models import (Evento, CadastroEscola,CapacidadesFundamentos, UnidadeCurricular, UnidadeCapacidade,
                     PeriodoPai, PeriodoFilha, Pessoa, Areatecnologica, Infraestrutura,Turma, Aula,
...
class PeriodoPaiSerializer(serializers.ModelSerializer):
    class Meta:
        model = PeriodoPai
        fields = '__all__'

class PeriodoFilhaSerializer(serializers.ModelSerializer):
    class Meta:
        model = PeriodoFilha
        fields = '__all__'
