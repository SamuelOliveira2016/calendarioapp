...
from .models import (CapacidadesFundamentos, CadastroEscola,Infraestrutura,AulaInfraestrutura, 
                     Aula, Evento, Pessoa, Turma, UnidadeCurricular, Areatecnologica, Periodo, HoraAulaCargaHoraria)
