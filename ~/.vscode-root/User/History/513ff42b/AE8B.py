...
from .views import (DetalhesUnidadeCurricularAPIView, alocar_aula_view,
                    ...
                    InfraestruturaDetailAPIView,  AulaAPIView, AulaInfraestruturaAPIView,
                    EventoAPIView, CalendarioAcademicoAPIView , CursoUnidadeCurricularProfessorAPIView,
                    PeriodoAPIView, UnidadeCurricularAPIView ,PessoaAPIView, AreaTecnologicaAPIView,CursoAPIView,
