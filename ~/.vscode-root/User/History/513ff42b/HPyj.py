...
from .views import ( EventoAPIView, CadastroEscolaAPIView, CapacidadesFundamentosAPIView, UnidadeCurricularAPIView, UnidadeCapacidadeAPIView,
                    PeriodoAPIView, HoraAulaCargaHorariaAPIView, alocar_aula_view, InfraestruturaAPIView, InfraestruturaDetailAPIView,  AulaAPIView, AulaInfraestruturaAPIView,
                      PessoaAPIView, AreaTecnologicaAPIView,TurmaAPIView,
                      )
