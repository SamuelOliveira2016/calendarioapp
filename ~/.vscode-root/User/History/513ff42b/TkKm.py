...
from .views import ( EventoAPIView, CadastroEscolaAPIView, CapacidadesFundamentosAPIView, 
                    ...
                    HoraAulaCargaHorariaAPIView, PessoaAPIView, InfraestruturaAPIView, 
                    InfraestruturaDetailAPIView, TurmaAPIView,
                    alocar_aula_view,   AulaAPIView, AulaInfraestruturaAPIView,
                       AreaTecnologicaAPIView )
