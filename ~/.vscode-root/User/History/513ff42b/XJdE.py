...
from .views import ( EventoAPIView, CadastroEscolaAPIView, CapacidadesFundamentosAPIView, 
                    ...
                    PeriodoDetalheAPIView, PessoaAPIView, AreaTecnologicaAPIView, 
...
urlpatterns = [
    ...
    path('periodo-pai/', PeriodoAPIView.as_view(), name='periodo-api'),
    path('periodo-filha/', PeriodoDetalheAPIView.as_view(), name='horas'),
