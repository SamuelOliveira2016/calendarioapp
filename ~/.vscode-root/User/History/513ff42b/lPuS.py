...
from .views import ( EventoAPIView, CadastroEscolaAPIView, CapacidadesFundamentosAPIView, UnidadeCurricularAPIView, UnidadeCapacidadeAPIView,alocar_aula_view, InfraestruturaAPIView, InfraestruturaDetailAPIView,  AulaAPIView, AulaInfraestruturaAPIView,
                     PeriodoAPIView, PessoaAPIView, AreaTecnologicaAPIView,TurmaAPIView,
                      HoraAulaCargaHorariaAPIView)
