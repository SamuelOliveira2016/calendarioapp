...
from .views import ( EventoAPIView, CadastroEscolaAPIView, CapacidadesFundamentosAPIView, 
                    UnidadeCurricularAPIView, UnidadeCapacidadeAPIView, PeriodoPaiAPIView, 
                    PeriodoFilhaAPIView, PessoaAPIView, AreaTecnologicaAPIView, 
...
urlpatterns = [
    ...
    path('periodo-pai/', PeriodoPaiAPIView.as_view(), name='periodo-api'),
    path('periodo-filha/', PeriodoFilhaAPIView.as_view(), name='horas'),
