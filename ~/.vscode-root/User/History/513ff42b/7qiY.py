...
from .views import ( EventoAPIView, InstituicaoAPIView, 
                    ...
                    PeriodoDetalheAPIView,HoraIntervaloAPIView, PeriodoIntervaloAPIView, PessoaAPIView, AreaTecnologicaAPIView, 
                    InfraestruturaAPIView, InfraestruturaDetailAPIView, TurmaAPIView,
                    AulaAPIView, AulaSalaAPIView, AulaProfessorAPIView, alocar_aula_view
                        )
